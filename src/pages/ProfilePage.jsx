...
import { User, Award, HardDrive, FileText, RefreshCw, Trash2, Music, Mic } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-full bg-darkBg px-6 pt-8 pb-24 overflow-y-auto no-scrollbar">
      ...
      <div className="flex flex-col items-center mb-6">
        <div className="w-24 h-24 rounded-full bg-gradient-to-br from-neonBlue to-neonGreen p-1 mb-3 shadow-[0_0_20px_rgba(34,211,238,0.2)]">
      ...
      {/* Vocal Range Chart - แก้ไข Layout ตรงนี้ */}
      <div className="bg-darkCard border border-slate-800 rounded-3xl p-5 mb-4 relative flex flex-col gap-4">
        ...
        {/* แถวบน: ตัวหนังสือ และ ปุ่ม Reset */}
        <div className="flex justify-between items-center w-full relative z-10">
          <div className="flex items-center gap-2">
            <span className="text-slate-400 font-bold text-[10px] sm:text-xs uppercase tracking-widest">Vocal Range:</span>
            <span className={`text-sm sm:text-base font-black tracking-tighter ${hasRange ? 'text-neonGreen' : 'text-slate-500'}`}>
          ...
          <button 
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-slate-800/80 text-slate-400 hover:text-white hover:bg-slate-700 transition-colors text-[10px] font-bold uppercase tracking-wider border border-slate-700 shrink-0"
          >
        ...
        <div className="flex flex-col relative z-10 w-full">
          <div className="relative h-10 w-full bg-slate-900 rounded-xl overflow-hidden border border-slate-800 shrink-0 mb-1.5">
            ...
            {hasRange ? (
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-[10px] font-bold text-slate-600 tracking-widest uppercase flex items-center gap-2">
                  <Mic size={12}/> Measure in Vocal Tab
                </span>
              </div>
            )}
          </div>
